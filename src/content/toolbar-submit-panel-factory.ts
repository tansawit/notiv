...
export function createToolbarSubmitPanelElements(
  ...
  if (submitHeading instanceof HTMLElement) {
    ...
    submitBackButton.style.border = `1.5px solid ${panelPalette.iconButtonBorder}`;
  ...
  submitTitleInput.style.height = '40px';
  submitTitleInput.style.border = 'none';
  submitTitleInput.style.borderBottom = `1.5px solid ${panelPalette.inputBorder}`;
  submitTitleInput.style.borderRadius = '0';
  submitTitleInput.style.padding = '4px 0 8px';
  ...
  submitTitleInput.style.fontSize = '18px';
  submitTitleInput.style.fontWeight = '520';
  ...
  submitDescriptionInput.style.height = '84px';
  submitDescriptionInput.style.minHeight = '84px';
  submitDescriptionInput.style.maxHeight = '84px';
  submitDescriptionInput.style.resize = 'none';
  submitDescriptionInput.style.border = 'none';
  submitDescriptionInput.style.borderBottom = `1.5px solid ${panelPalette.inputBorder}`;
  submitDescriptionInput.style.borderRadius = '0';
  submitDescriptionInput.style.padding = '6px 0 8px';
  ...
  submitDescriptionInput.style.marginTop = '2px';
  ...
  const syncSubmitFieldBorder = (field: HTMLInputElement | HTMLTextAreaElement, focused: boolean): void => {
    ...
    field.style.borderBottom = `1.5px solid ${focused ? focusColor : fieldPalette.inputBorder}`;
  };
